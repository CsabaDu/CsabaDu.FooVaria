...
public abstract class DynamicDataSource(ArgsCode argsCode)
{
    ...
    protected string Definition { private get; set; } = null;
    ...
    protected object[] TestDataToArgs<T1>(string exitMode, T1 arg1)
    => new TestData<string, T1>(Definition, exitMode, arg1).ToArgs(ArgsCode);

    protected object[] TestDataToArgs<T1, T2>(string exitMode, T1 arg1, T2 arg2)
    => new TestData<string, T1, T2>(Definition, exitMode, arg1, arg2).ToArgs(ArgsCode);

    protected object[] TestDataToArgs<T1, T2, T3>(string exitMode, T1 arg1, T2 arg2, T3 arg3)
    => new TestData<string, T1, T2, T3>(Definition, exitMode, arg1, arg2, arg3).ToArgs(ArgsCode);

    protected object[] TestDataToArgs<T1, T2, T3, T4>(string exitMode, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    => new TestData<string, T1, T2, T3, T4>(Definition, exitMode, arg1, arg2, arg3, arg4).ToArgs(ArgsCode);

    protected object[] TestDataToArgs<T1, T2, T3, T4, T5>(string exitMode, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
    => new TestData<string, T1, T2, T3, T4, T5>(Definition, exitMode, arg1, arg2, arg3, arg4, arg5).ToArgs(ArgsCode);

    protected object[] TestDataToArgs<T1, T2, T3, T4, T5, T6>(string exitMode, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6)
    => new TestData<string, T1, T2, T3, T4, T5, T6>(Definition, exitMode, arg1, arg2, arg3, arg4, arg5, arg6).ToArgs(ArgsCode);

    protected object[] TestDataToArgs<T1, T2, T3, T4, T5, T6, T7>(string exitMode, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
    => new TestData<string, T1, T2, T3, T4, T5, T6, T7>(Definition, exitMode, arg1, arg2, arg3, arg4, arg5, arg6, arg7).ToArgs(ArgsCode);
    #endregion
