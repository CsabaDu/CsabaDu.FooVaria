...
public interface IBaseMeasure : IMeasurable, IQuantity, IRateComponent, IRateComponentType, IRateComponentType<IBaseMeasure>, IQuantity<IBaseMeasure>, IExchangeRate<IBaseMeasure>, IProportional<IBaseMeasure, Enum>
{
