...
public interface IBaseMeasure : IMeasurable, IRateComponent, IQuantityType, IDecimalQuantity, ILimitMode, IRateComponentType, IRateComponentType<IBaseMeasure>, IQuantity<IBaseMeasure>, IExchangeRate<IBaseMeasure>, IExchange<IBaseMeasure, Enum>
{
