...
{
    public interface IMeasure : IRateComponent, ILimitable, ICalculate, ICalculate<decimal, IMeasure>
    {
    ...
    public interface IMeasure<out T, U> : IMeasure, IDefaultBaseMeasure<T, U> where T : class, IMeasure, IDefaultRateComponent where U : struct
    {
