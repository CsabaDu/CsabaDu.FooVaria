...
namespace CsabaDu.FooVaria.Proportions.Types
{
    ...
    public interface IProportion<out T, in W, in U> : IProportion<T, U> where T : class, IProportion<T, W, U>, IMeasureProportion where U : struct, Enum where W : struct, Enum
    {
