...
{
    public interface IBaseMeasure : IQuantifiable, IExchangeRate, IRateComponentCode, IQuantityTypeCode, ILimitMode, IEqualityComparer<IBaseMeasure>, IRound<IBaseMeasure>
    {
