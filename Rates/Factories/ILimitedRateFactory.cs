...
public interface ILimitedRateFactory : IRateFactory, IFactory<ILimitedRate>
{
    ...
    ILimitedRate Creat(IMeasure numerator, Enum measureUnit, ValueType quantity, ILimit limit);
    ILimitedRate Creat(IMeasure numerator, string name, ILimit limit);
    ILimitedRate Creat(IMeasure numerator, Enum measureUnit, ILimit limit);
