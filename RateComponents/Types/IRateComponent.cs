...
{
    public interface IRateComponent : IBaseMeasure, IQuantity, IQuantityTypeCode, IDecimalQuantity, ILimitMode, IRateComponentCode, IExchangeRate, IExchange<IRateComponent, Enum>, IRound<IRateComponent>
    {
